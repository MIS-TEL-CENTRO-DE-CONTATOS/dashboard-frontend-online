                ...
                <div className="mt-2">
                  <div className="flex">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      className="block pl-9 w-full rounded-md border-0 py-1.5 focus:shadow-none focus:border-danger focus:ring-1 text-danger ring-2 ring-inset ring-danger sm:text-sm sm:leading-6"
                      disabled
                    />
                  </div>
                </div>{" "}
                <p className="text-xs text-center py-4 ">
                  This email was not found in our database.
                  In case of problems contact our
                  administrators
                </p>
              </div>
