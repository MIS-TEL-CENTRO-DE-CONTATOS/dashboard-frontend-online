...
import { FiChevronsRight, FiLock, FiMail } from "react-icons/fi";
                ...
                <div className="mt-2">
                  <div className="flex">
                    ...
                    <input
                      ...
                      autoComplete="email"
                      required
                      className="block pl-9 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:border-primary focus:ring-primary sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="mt-2">
                  ...
                  <input
                    ...
                    required
                    className="block pl-9 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-primary focus:ring-2 focus:ring-inset focus:border-primary focus:ring-primary sm:text-sm sm:leading-6"
                  />
                </div>
              </div>
              <div className="flex items-center">
               <Checkbox color="red" defaultChecked />
                <p className="pl-2 text-xs text-gray-500">Remember me</p>
              </div>
